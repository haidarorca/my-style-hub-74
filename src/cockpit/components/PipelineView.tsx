...
const COLUMNS: Column[] = [
  { key: "new", title: "À confirmer", short: "Nouv.", color: "border-t-purple-500", bgColor: "bg-purple-50", chipBg: "bg-purple-100", chipText: "text-purple-700", statuses: ["", "new"] },
  { key: "contacted", title: "Contactée", short: "Contact.", color: "border-t-blue-500", bgColor: "bg-blue-50", chipBg: "bg-blue-100", chipText: "text-blue-700", statuses: ["contacted"] },
  ...
  { key: "to_weigh", title: "À peser", short: "Peser", color: "border-t-orange-500", bgColor: "bg-orange-50", chipBg: "bg-orange-100", chipText: "text-orange-700", statuses: ["awaiting_weighing"] },
  ...
  { key: "ready", title: "Prête", short: "Prête", color: "border-t-emerald-500", bgColor: "bg-emerald-50", chipBg: "bg-emerald-100", chipText: "text-emerald-700", statuses: ["ready", "ready_delivery"] },
