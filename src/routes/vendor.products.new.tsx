          ...
          <Card>
            <CardContent className="space-y-4 pt-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[11px] text-muted-foreground">
                  ⚠️ Optionnel et déconseillé si vous avez plusieurs variantes. Utilisez plutôt la <b>Référence variante</b> sur chaque ligne (Rouge M, Bleu L, etc.) — c'est ce qui est utilisé pour le stock, les commandes et le SAV. Jamais affiché aux clients.
                </p>
              </div>
            </CardContent>
          </Card>
