-- Migration : Ajouter is_commission à la vue logistique
-- Le Cockpit ne doit afficher QUE les commandes par commission
...
-- Recréer la fonction get_logistics_stats (dépend de la vue)
